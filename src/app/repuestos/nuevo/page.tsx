...
import { Plus, Package, X, DollarSign, Truck, AlertTriangle, Info, Warehouse, ShoppingCart, Settings, Tag, Building2, Box, TrendingUp, CheckCircle } from 'lucide-react'
...
export default function NuevoRepuestoPage() {
  ...
  const { addSparePart, machinery } = useApp()
  ...
  // Obtener la maquinaria seleccionada para mostrar su nombre
  ...
  const onSubmit = async (data: SparePartFormData) => {
    ...
    await addSparePart(newSparePart)
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl shadow-xl">
          ...
          <div className="relative p-8 flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white mb-1">Nuevo Repuesto</h1>
                <p className="text-blue-100">Completa la información para registrar un nuevo repuesto en el inventario</p>
              </div>
            </div>
            <Button
              variant="outline"
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select onValueChange={field.onChange} value={field.value}>
                              <SelectTrigger className={`h-11 ${errors.supplier ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-purple-500 focus:ring-purple-500'}`}>
                        ...
                        <p className="text-xs text-gray-500">Selecciona el proveedor o distribuidor</p>
                      </div>
                    </div>
                  </div>
